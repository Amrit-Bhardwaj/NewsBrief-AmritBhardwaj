 ...
 */
class GetArticleDetailsTask: Task {
    ...
    init(apiKey: String, country: String, category: String, pageSize: String, page: String) {
            self.apiKey = apiKey
        ...
        var request: Request {
            return UserRequests.articleDetails(country: country, category: category, apiKey: apiKey, pageSize: pageSize, page: page)
        }
